...
public class Traducir {
   ...
   public static String traducio="", afirmati="";
    ...
    String linea;  
    String escribir="";
    BufferedReader reader=new BufferedReader(new FileReader("D:\\Erickson\\Universidad\\7mo Semestre\\Compiladores\\Proyecto\\Traductor\\src\\Otros\\verbos.csv"));
...
//System.out.print("¿Tu "+arreglo_datos[2]+"?\n");
     ...
     public void simpleafir(String palabra) throws IOException
     {
         ...
         String escribir="";
         BufferedReader reader=new BufferedReader(new FileReader("D:\\Erickson\\Universidad\\7mo Semestre\\Compiladores\\Proyecto\\Traductor\\src\\Otros\\verbos.csv"));
         BufferedReader r = new BufferedReader(new FileReader("D:\\Erickson\\Universidad\\7mo Semestre\\Compiladores\\Proyecto\\Traductor\\src\\Otros\\adv.csv"));
